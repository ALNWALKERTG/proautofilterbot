...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
                      ...
                      'html',
                       reply_markup=InlineKeyboardMarkup(
                           [
                               ...
                               [
                                   InlineKeyboardButton("⚠️ 𝖢𝖺𝗇'𝗍 𝖠𝖼𝖼𝖾𝗌𝗌 ❓ 𝖢𝗅𝗂𝖼𝗄 𝖧𝖾𝗋𝖾 ⚠️", url=f'https://t.me/MOVIE_ROCKERS_MR')
                               ]
                           ]
                       )
                    )
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💠 GᏒԾUᎮ 💠', url='https://t.me/CINEMA_CORNER_MOVIES_CCM'),
            InlineKeyboardButton('💠 CHΛИИΞL 💠', url='https://t.me/CCM_LINKS')         
            ],[
        ...
        buttons= [[
            InlineKeyboardButton('♥️ SԾUᏒCΞ ♥️', url='https://t.me/cinemavilla_updates')
            ],[
