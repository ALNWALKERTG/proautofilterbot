...
➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖
 ...
 ©️MᴀɪɴᴛᴀɪɴᴇD Bʏ:<a href=@oreoolspecialone>꧁•ᬼ̩༒𝘀𝗽𝗲𝗰𝗶𝗮𝗹_𝗼𝗻𝗲 ༒•ᬼ̩</a> """
    HELP_TXT = """𝙷𝙴𝚈 {}
𝙷𝙴𝚁𝙴 𝙸𝚂 𝚃𝙷𝙴 𝙷𝙴𝙻𝙿 𝙵𝙾𝚁 𝙼𝚈 𝙲𝙾𝙼𝙼𝙰𝙽𝙳𝚂 imdb ."""
    ABOUT_TXT = """✮ 𝙼𝚈 𝙽𝙰𝙼𝙴: {}
...
<a href=<a href=https://t.me/ALANWALKER_TG >ALAN WALKER TG</a>"""
...
<b>NOTE:</b>
these are the extra features of @CINEMAVILLA_GROUP
<b>Commands and Usage:</b>
...
➛𝖤𝗑𝖺𝗆𝗉𝗅𝖾:
/short https://t.me/CINEMAVILLA_GROUP"""
...
𝖬𝖺𝖽𝖾 𝖻𝗒 <a href=https://t.me/cinemavilla_group >𝐂𝐢𝐧𝐞𝐦𝐚 𝐕𝐢𝐥𝐥𝐚🎬 [𝑴𝒐𝒗𝒊𝒆𝒔 & 𝑺𝒆𝒓𝒊𝒆𝒔]</a>"""
